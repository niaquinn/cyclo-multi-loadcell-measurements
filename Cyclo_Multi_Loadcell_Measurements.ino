...
const int HX711_sck_1 = 19; //mcu > HX711 no 1 sck pin
...
const int HX711_dout_4 = 4; //mcu > HX711 no 4 dout pin
const int HX711_sck_4 = 19; //mcu > HX711 no 4 sck pin
...
void setup() {
  ...
  calibrationValue_1 = 722.75; // uncomment this if you want to set this value in the sketch
  calibrationValue_2 = 756.43; // uncomment this if you want to set this value in the sketch
  calibrationValue_3 = 737.07; // uncomment this if you want to set this value in the sketch
  calibrationValue_4 = 704.29; // uncomment this if you want to set this value in the sketch
...
void loop() {
  ...
  const int serialPrintInterval = 10; //increase value to slow down serial print activity, represents milliseconds between measurements
